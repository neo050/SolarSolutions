...
export const SOLAR: ServicePage[] = [
...

  {
    ...
    title:
      "התקנת מערכת סולארית לבית פרטי — מה בודקים בגג",
    description:
      "התקנת מערכת סולארית לבית פרטי — על גג רעפים, גג שטוח או סככה. מה בודקים לפני שמתחייבים: שטח פנוי, כיוון והצללה, מצב הגג והלוח, ומתי כדאי להוסיף אגירה.",
    lede:
...

  {
    ...
    description:
      "אגירת אנרגיה לבית ולעסק, כתוספת למערכת סולארית או כמערכת עצמאית. מה באמת נדרש לגיבוי בהפסקת חשמל, איך בוחרים גודל סוללה, וניסיון במערכות מנותקות רשת.",
    lede:
