...
export const GAPS: Gap[] = [
  ...
  },
  {
    ...
    why:
      ...
      "עודכן: הפער הזה כבר היה רשום, וארבע התמונות בכל זאת נשארו בסטטוס IN USE והתפרסמו " +
      "בשלושה עמודים. הערה שמסמנת סיכון בלי לשנות סטטוס לא מונעת כלום — ולכן כל הארבע " +
      "הועברו ל-quarantine/commercial/ ובדיקת ה-QA נכשלת אם אחת מהן חוזרת לתיקייה " +
      "המפורסמת. " +
      "בפריימים מופיעים לא רק השילוט אלא גם הלוגו של 'קצפת', תפריט מחירים מלא, שילוט של " +
      "עסקים שכנים ותוכניות אדריכליות מודבקות על הקיר. " +
      "נשמר באתר: הגזירה לרוחב של תמונת ההכנה (lighting-01-wide), שבה כל הסימנים המזהים " +
      "מחוץ לפריים. היא כעת התמונה הראשית של עמוד התאורה ושל עמוד התשתיות.",
    source: "business-owner",
    needsTruth: true,
    aiFillable: "no",
    priority: "P1",
    status: "missing",
    closes:
      "הודעת וואטסאפ אחת לבעל העסק: 'אפשר להעלות לאתר תמונות מהעבודה אצלכם, כולל השילוט?'. " +
      "תשובה חיובית בכתב מספיקה, ואז שלוש התמונות החזקות ביותר בכל המאגר המסחרי חוזרות.",
  },
  {
